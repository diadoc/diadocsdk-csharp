...
namespace Diadoc.Api
{
	...
	public class AggregateException : Exception
	{
		...
		private const string innerExceptionItemIsNull = "An element of innerExceptions was null.";
		private const string defaultToStringFormat = "{0}{1}---> (Inner Exception #{2}) {3}{4}{5}";
		private const string serializationExceptionMessage = "innerException is null";
			...
			: base(message, innerExceptions != null && innerExceptions.Count > 0 ? innerExceptions[0] : null)
		{
			...
			for (int i = 0; i < exceptionsCopy.Length; i++)
			{
				...
				{
					throw new ArgumentException(innerExceptionItemIsNull);
				}
			}
			...
			base(info, context)
		{
			...
			if (innerExceptions == null)
			{
				throw new SerializationException(serializationExceptionMessage);
			}
