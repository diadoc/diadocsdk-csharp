...
namespace Diadoc.Api
{
	public interface IDiadocApi
	{
		...
		string AuthenticateByOidc(string clientId, string clientSecret, string refreshToken);
 ...
 null, string id = null, bool autoConfirm = true);
		...
		Task<string> AuthenticateByOidcAsync(string clientId, string clientSecret, string refreshToken);
