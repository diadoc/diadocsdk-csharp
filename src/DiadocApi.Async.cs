...
namespace Diadoc.Api
{
	public partial class DiadocApi
	{
		...
		public Task<OrganizationList> GetOrganizationsByForeignTaxpayerCodeAsync(string authToken, string foreignTaxpayerCode, bool includeRelations = false)
		{
			if (authToken == null) throw new ArgumentNullException(nameof(authToken));
			if (foreignTaxpayerCode == null) throw new ArgumentNullException(nameof(foreignTaxpayerCode));
			return diadocHttpApi.GetOrganizationsByForeignTaxpayerCodeAsync(authToken, foreignTaxpayerCode, includeRelations);
		}
		...
		public Task<MessageValidationResult> CanPostMessageAsync(string authToken, MessageToPostPrototype prototype)
		{
			...
			return diadocHttpApi.CanPostMessageAsync(authToken, prototype);
		}
		...
		public Task<GeneratedFile> GenerateUniversalMessageAsync(string authToken, string boxId, string messageId, string attachmentId, byte[] userContractData)
		{
			if (authToken == null) throw new ArgumentNullException(nameof(authToken));
			if (boxId == null) throw new ArgumentNullException(nameof(boxId));
		...
		{
			if (authToken == null) throw new ArgumentNullException(nameof(authToken));
			return diadocHttpApi.ParseGarAddressAsync(authToken, address);
		}
		...
		public Task<DocumentWorkflowSettingsListV3> GetWorkflowsSettingsV3Async(string authToken, string boxId)
		{
			...
			if (string.IsNullOrEmpty(boxId))
				throw new ArgumentNullException(nameof(boxId));
			return diadocHttpApi.GetWorkflowsSettingsV3Async(authToken, boxId);
		}
		...
		public Task<GetDocumentTypesResponseV3> GetDocumentTypesV3Async(string authToken, string boxId)
		{
			...
			if (string.IsNullOrEmpty(boxId))
				throw new ArgumentNullException("boxId");
			return diadocHttpApi.GetDocumentTypesV3Async(authToken, boxId);
		}
